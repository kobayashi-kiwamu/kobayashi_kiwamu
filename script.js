...
let correctCounter = 0;//連続正解数をカウントする関数

// それぞれのパラメータを格納する変数
const body = document.querySelector("body")
const ansBtn = document.getElementsByClassName("answer")[0]//answerというクラスの要素の0番目
...
ansBtn.addEventListener("click", () => {
  ...
  if (input.value == ans) {
    kaito.innerHTML = "せいかいです"
    arrayOfCorOrIncor.push("〇")
    correctCounter += 1
  } else {
    kaito.innerHTML = "まちがいです こたえは" + ans + "です"
