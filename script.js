...
// //正解不正解を確認して配列に結果を保存する関数
// function correctOrIncorrect() {
//   if (input.value == ans) {
//     document.getElementsByClassName("kaito").innerHTML = "正解です"
//     arrayOfCorOrIncor.push(true)
//   } else {
//     document.getElementsByClassName("kaito").innerHTML = "間違いです"
//     arrayOfCorOrIncor.push(false)
//   }
//   counter += 1;
//   arrayOfNum1.push(num1);
//   arrayOfNum2.push(num2);
